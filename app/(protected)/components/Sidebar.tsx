                  ...
                  <>
                    ...
                    {isCadastroLocaisOpen && (
                      <div className="mt-2 ml-4 flex flex-col gap-1">
                        <Link href="/local-nivel1" className="block px-1 py-1 rounded-md hover:bg-blue-600/60">
                          <span className="text-sm">Cadastro Local Nível 1</span>
                        </Link>
                        <Link href="/local-nivel2" className="block px-1 py-1 rounded-md hover:bg-blue-600/60">
                          <span className="text-sm">Cadastro Local Nível 2</span>
                        </Link>
                        <Link href="/local-nivel3" className="block px-1 py-1 rounded-md hover:bg-blue-600/60">
                          <span className="text-sm">Cadastro Local Nível 3</span>
                        </Link>
                        <Link href="/local-nivel4" className="block px-1 py-1 rounded-md hover:bg-blue-600/60">
                          <span className="text-sm">Cadastro Local Nível 4</span>
                        </Link>
                      </div>
                    )}
                  </>
