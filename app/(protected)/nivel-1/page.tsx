...
function LocalNivel1Page() {
  ...
  React.useEffect(() => {
    setTitle('Locais Nivel 1');
    setSubtitle('Cadastro de Locais Nivel 1');
    setDescription('Controle e monitore todas os locais nivel 1 das suas obras');
...
export default LocalNivel1Page;
